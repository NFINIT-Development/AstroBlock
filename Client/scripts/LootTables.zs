...
val lostcitychestReward = lostcitychest.addPool("lostcitychestReward", 1, 1, 0, 0);
    ...
    lostcitychestReward.addItemEntry(<exocraft:lava_crystal>, 1);
	lostcitychestReward.addItemEntry(<galacticraftcore:schematic>, 1);
...
val lostcitychestReward3 = abandoned_mineshaft.addPool("lostcitychestReward3", 1, 1, 0, 0);
	...
	lostcitychestReward3.addItemEntry(<inventorypets:torch_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:biome_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:flying_saddle_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:sun_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:pixie_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:meta_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:dirt_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:lead_pet>, 1);
	lostcitychestReward3.addItemEntry(<inventorypets:brewing_stand_pet>, 1);
